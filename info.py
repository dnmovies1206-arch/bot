...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7734821136 8141314253').split()] # Replace with the actual admin ID(s) to add
