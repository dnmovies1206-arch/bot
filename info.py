...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6390511215 7734821136 8141314253').split()] # Replace with the actual admin ID(s) to add
...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1002988640125")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/dragonkannadavmovie")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/dragonkannadavmovie")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/dragonkannadavmovie")   # Third tutorial link for verification
