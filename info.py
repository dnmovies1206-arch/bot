...
# ============================
SESSION = environ.get('SESSION', 'dn')   # Session name for the bot
API_ID = int(environ.get('API_ID', '26045039')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', 'affd39f67da102a83f0f9e5c96cf84fe')  # API Hash from my.telegram.org
BOT_TOKEN = environ.get('BOT_TOKEN', "")    # Bot token from @BotFather

# ============================
# Bot Settings Configuration
# ============================
CACHE_TIME = int(environ.get('CACHE_TIME', 790))    # Cache time in seconds (default: 5 minutes)
USE_CAPTION_FILTER = bool(environ.get('USE_APTION_FILTER', True))  # Use caption filter for search results (default: True)
...
PICS = (environ.get('PICS', 'https://files.catbox.moe/vens42.jpg')).split()  # Sample pic
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8141314253').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003338128026').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003434477634'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003434477634'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003434477634'))  # Premium logs channel id
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003469200638')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003469200638')  # Request channel id (make sure bot is admin)
...
auth_channels     = environ.get("AUTH_CHANNELS", "-1002988640125")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://i.ibb.co/5gQV9fNV/photo-2026-01-21-03-57-26-7597659080605302800.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 's.bannappa@superyes')    # Owner UPI ID for payments 
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://dnmovies:dnmovies@cluster0.vyeygpr.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "dnmovie") # Database name (default: cluster)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'dnmovie') # Collection name (default: dreamcinezone_files)
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1003434477634')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1003434477634')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
VERIFY_IMG = environ.get("VERIFY_IMG", "https://files.catbox.moe/cb0inw.jpg")

TUTORIAL = environ.get("TUTORIAL", "https://t.me/+DLC4ztUnnVdmYzY1")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/+DLC4ztUnnVdmYzY1")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/+DLC4ztUnnVdmYzY1")   # Third tutorial link for verification

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("cpmshort.com", "73c7a540e97137b2cf0428d76162ae71dc0a59fb") # Shortener API key
SHORTENER_WEBSITE = environ.get("cpmshort.com", "shortxlinks.com") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "73c7a540e97137b2cf0428d76162ae71dc0a59fb")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "cpmshort.com") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "73c7a540e97137b2cf0428d76162ae71dc0a59fb")  
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "cpmshort.com") # Shortener website for third website

TWO_VERIFY_GAP = int(environ.get('TWO_VERIFY_GAP', "60")) # Time gap for two-step verification in seconds (default: 20 minutes)
THREE_VERIFY_GAP = int(environ.get('THREE_VERIFY_GAP', "60"))    

# ============================
# Channel & Group Links Configuration
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/dragonkannadavmovie https://t.me/dragonmoviesgroup') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/+GB4qVgc43bE2MWY9') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/+GB4qVgc43bE2MWY9') # Update channel link for the bot
...
SESSION_NAME = str(environ.get('SESSION_NAME', 'dn'))
MULTI_CLIENT = False
name = str(environ.get('name', 'dn'))
